...
Wraith is a **186M-parameter** LLM that packs to **74.9 MB**, runs at **501 tokens/sec** on a consumer RTX 5070, and sips **64 mJ per token**. At that size it delivers **5.73× better perplexity** on WikiText-103 val than an architecture-identical LLaMA fp16 trained on the same tokens.
