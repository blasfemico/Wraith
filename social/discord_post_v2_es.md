...
Wraith es un LLM de **186M parámetros** que pesa **74.9 MB** empaquetado, corre a **501 tokens/seg** en una RTX 5070 consumer y consume **64 mJ por token**. A ese tamaño tira **6.24× mejor perplejidad** que un LLaMA fp16 con arquitectura idéntica entrenado con los mismos tokens.
