...
Scale
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
\textbf{Wraith (hypothetically optimal)}\textasciitilde50-100 tok/param
at quality-target
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
BitNet (empirical)\textasciitilde2,000 tok/param
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
Modern fp16 (production)\textasciitilde500-2,500 tok/param
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 19: Convergence efficiency}]{charts/19_convergence_efficiency.png}}
\caption{Figure 19: Convergence efficiency}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 11: Dualwire forward diagram}]{charts/11_dualwire_forward.png}}
\caption{Figure 11: Dualwire forward diagram}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 12: Training pipeline}]{charts/12_training_pipeline.png}}
\caption{Figure 12: Training pipeline}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 13: SoTT inference}]{charts/13_sott_inference.png}}
\caption{Figure 13: SoTT inference}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 14: Full model architecture}]{charts/14_model_architecture.png}}
\caption{Figure 14: Full model architecture}
\end{figure}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1507}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.3425}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
...
& 10 MB & \textbf{114 MB ✓} & \textasciitilde400 MB \\
...
Peak bandwidth
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
Effective bandwidth (40\%)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
\textbf{Projected tok/s}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
\(/hour (2026) | **\)/1M tok (single-user)**
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
\end{minipage} \\
\midrule\noalign{}
\endhead
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 15: Training VRAM vs.~scale}]{charts/15_training_vram_scaling.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 16: Inference VRAM vs.~scale}]{charts/16_inference_vram_scaling.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 17: Training cost vs.~scale}]{charts/17_training_cost_scaling.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 18: Bytes per parameter}]{charts/18_bytes_per_param.png}}
...
Model
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
Wraith runtime packed (VRAM)
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
fp16 LLaMA equivalent
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
Ratio
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
80 GB datacenter GPUs (Wraith)
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
80 GB GPUs (fp16)
\end{minipage} \\
\midrule\noalign{}
...
vs.~cuBLAS fp16
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Why it lost on consumer Blackwell
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
KV with TQ + CLRG
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
Total Wraith packed + KV-TQ+CLRG
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
H100s (80GB)
\end{minipage} \\
\midrule\noalign{}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 1: PPL across 5 datasets}]{charts/01_val_ppl_5datasets.png}}
\emph{Figure 1: Validation PPL across 5 datasets. Log scale. Ratios
2.11--10.39× annotated.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 2: Train vs.~val gap}]{charts/02_train_val_gap.png}}
\emph{Figure 2: Generalization gap (post-hoc). Wraith 1.37× vs.~fp16
3.59× = 2.62× smaller.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 3: Training cost}]{charts/03_training_cost.png}}
\emph{Figure 3: Training cost. \$19.19 vs.~\$214.20 at equivalent
quality (11.2×).}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 4: Energy per token}]{charts/04_energy_per_token.png}}
\emph{Figure 4: Energy per token measured by NVML hardware counter.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 5: Zero-shot}]{charts/05_zero_shot.png}}
\emph{Figure 5: Zero-shot accuracy across 3 benchmarks.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 6: Inference stacks}]{charts/06_inference_stacks.png}}
\emph{Figure 6: CPU + GPU inference throughput, log scale.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 7: Storage compression}]{charts/07_storage.png}}
\emph{Figure 7: 4.97× compression, 98.2\% of Shannon limit, lossless
bit-exact.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 8: Threshold ablation}]{charts/09_ablation_threshold.png}}
\emph{Figure 8: Identical PPL across 5 threshold configurations (10/6 to
30/18).}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 9: Per-layer sparsity}]{charts/10_ablation_sparsity.png}}
\emph{Figure 9: Active density per layer. L0: 35--45\%, L7: 85--88\%.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 11: Dualwire forward}]{charts/11_dualwire_forward.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 14: Model architecture}]{charts/14_model_architecture.png}}
\emph{Figure 14: Full Wraith-186M architecture.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 20: Scaling projection}]{charts/20_scaling_projection.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Figure 21: Pareto frontier}]{charts/21_pareto_frontier.png}}
