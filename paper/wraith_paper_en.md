...
8. **Practical efficiency**: lossless packing to 74.9 MB (4.97× compression), CPU inference at 52.1 tok/s via a C++ AVX2 engine, and 11.2× lower training cost to reach equivalent quality.
...
**This is potentially the highest-impact finding of the paper.** In the current era, where large AI labs face a scarcity of high-quality training text (Villalobos et al., 2024; Muennighoff et al., 2023), a paradigm that reaches better quality with **~20–30× fewer tokens than BitNet and ~2–3× fewer than modern fp16** has implications beyond compute efficiency: **it directly reduces the demand for training data**, which is currently the economic and physical bottleneck of LLM scaling.
